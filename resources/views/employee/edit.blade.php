                    ...
                    <div class="p-5 bg-light rounded-3 col-xl-6">
                        ...
                        @error('firstName') is-invalid @enderror"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input class="form-control @error('cv') is-invalid @enderror" type="file" name="cv" id="cv">
                                @if ($employee->original_filename)
                                    <p>Current file: {{ $employee->original_filename }}</p>
                                    <a href="{{ route('employees.deleteFile', ['employee' => $employee->id]) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('delete')
